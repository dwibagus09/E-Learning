...
<h1 class="h4 text-gray-900 mb-4">Tambah Soal</h1>
</div> 
 <form action ="<?php echo base_url().'index.php/Page/tambah_jurusan';?>" method="POST">
		<div class="form-group">
		<label for="count_add">Masukkan Jumlah Soal</label>
